...
// fork testin in arbitrum: forge test -vvvv --fork-url https://arb1.arbitrum.io/rpc --match-test

contract SwapAppTest is Test {

    SwapApp app;
    address uniswapV2SwappRouterAddress = 0x4752ba5DBc23f44D87826276BF6Fd6b1C372aD24;
    address user = 0x1823933ddBAB0A12cd33F4d2a4A630F4549a62EF; // Address with USDT in Arbitrum Mainnet
